        ...
        public List<ClienteDto> GetClientesDto()
        {
            try
            {
                ...
                using (var conn = new SqlConnection(cadenaConexion))
                {
                    ...
                    string selectQuery = @"Select c.ClienteId, c.NombreCliente, c.CiudadId, ci.NombreCiudad, c.PaisId, pa.NombrePais
                                FROM Clientes c
                                inner Join Ciudades ci on c.CiudadId=c.CiudadId
                        ...
                        using (var reader = cmd.ExecuteReader())
                        {
                            while (reader.Read())
                            {
                                var cliente = new ClienteDto()
                                {
                                    ClienteId = reader.GetInt32(0),
                                    NombreCliente=reader.GetString(1),
                                    CiudadId = reader.GetInt32(2),
                                    NombreCiudad = reader.GetString(3),
                                    PaisId = reader.GetInt32(4),
                                    NombrePais=reader.GetString(5)
